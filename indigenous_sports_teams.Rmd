...
ggplot() +
  ...
  geom_point(data=city_link, aes(x=lon, y=lat),color="white",fill="white",alpha=0.2,shape=21)+
    geom_point(data=city_link, aes(x=lon, y=lat),color="black",fill="dodgerblue4",alpha=0.2,shape=21)+
    geom_point(data=city_link, aes(x=lon, y=lat),color="dodgerblue4",alpha=0.3,shape=1)+
