...
ggplot() +
  ...
  geom_point(data=city_link, aes(x=lon, y=lat),color="white",fill="white",alpha=0.2,shape=21)+
    ...
    theme_void()+
    labs(title="Indigenous Roots", subtitle="Secondary sports teams with names/mascots derived from indigenous peoples",caption="Data from Wikipedia",color="Indigenous term",fill="Indigenous term")+
    theme_ipsum_rc()+
